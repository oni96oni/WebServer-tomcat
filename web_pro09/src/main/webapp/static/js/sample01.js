...
res2.innerHTML += "arr1[0] -> " + arr1[1] + "<br>";
res2.innerHTML += "arr1[0] -> " + arr1[2] + "<br>";
res2.innerHTML += "arr1[0] -> " + arr1[3] + "<br>";
...
res6.innerHTML += "arr1.push(10) -> 배열의 크기가 : " + arr1.push(10) + "<br>";
res6.innerHTML += "실행 후 출력 결과" + arr1 + "<br>";
res6.innerHTML += "arr1.push(20) -> 배열의 크기가 : " + arr1.push(20) + "<br>";
res6.innerHTML += "실행 후 출력 결과" + arr1 + "<br>";
res6.innerHTML += "<br>";

res7 = document.getElementById("res7");
res7.innerHTML += "arr1.unshift(10) -> 배열의 크기가 : " + arr1.unshift(10) + "<br>";
res7.innerHTML += "실행 후 출력 결과" + arr1 + "<br>";
res7.innerHTML += "arr1.unshift(20, 30) -> 배열의 크기가 : " + arr1.unshift(20, 30) + "<br>";
res7.innerHTML += "실행 후 출력 결과" + arr1 + "<br>";
res7.innerHTML += "<br>";

res8 = document.getElementById("res8");
res8.innerHTML += "arr1.pop() -> 삭제된 값은" + arr1.pop() + "<br>";
res8.innerHTML += "실행 후 출력 결과" + arr1 + "<br>";
res8.innerHTML += "<br>";

res9 = document.getElementById("res9");
res9.innerHTML += "arr1.shift() -> 삭제된 값은" + arr1.shift() + "<br>";
res9.innerHTML += "실행 후 출력 결과" + arr1 + "<br>";
res9.innerHTML += "<br>";

res10 = document.getElementById("res10");
res10.innerHTML += "arr1.slice() ->" + arr1.slice() + "<br>";
res10.innerHTML += "arr1.slice(2,6) ->" + arr1.slice(2,6) + "<br>";

res11 = document.getElementById("res11");
res11.innerHTML += "arr1->" + arr1 + "<br>";
res11.innerHTML += "arr1.splice() ->" + arr1.splice() + "<br>";
res11.innerHTML += "arr1->" + arr1 + "<br>";
res11.innerHTML += "arr1.splice(2,6,15,16) ->" + arr1.splice(2,6,15,16) + "<br>";
res11.innerHTML += "arr1->" + arr1 + "<br>";

res12 = document.getElementById("res12");
res12.innerHTML += "arr1.sort() -> " + arr1.sort(); + "<br>";
res12.innerHTML += "<br>";
res12.innerHTML += "arr1.sort(function(x,y) {return x-y}) -> " + arr1.sort(function(x,y) {return x-y}) + "<br>";
res12.innerHTML += "arr1.sort(function(x,y) {return y-x}) -> " + arr1.sort(function(x,y) {return y-x}) + "<br>";
res12.innerHTML += "arr1.sort() -> " + arr1.sort(); + "<br>";
res12.innerHTML += "<br>";
res12.innerHTML += "arr1.sort() -> " + arr1.sort(); + "<br>";
res12.innerHTML += "<br>";
